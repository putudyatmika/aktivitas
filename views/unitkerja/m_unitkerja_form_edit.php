<div class="row wrapper border-bottom white-bg page-heading">
	...
	<li>
        <a href="<?php echo $url; ?>/dataunitkerja/">Master Unit Kerja</a>
    </li>
    <li class="active">
...
<div class="row wrapper wrapper-content animated fadeInRight">
	 <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    ?>
                        <form id="formUnitKerja" name="formUnitKerja" action="<?php echo $url.'/'.$page;?>/update/"  method="post" class="form-horizontal" role="form">
        <fieldset>
            ...
            <label for="unit_parent" class="col-sm-2 control-label">Parent Unit</label>
                ...
                <span class="input-group-addon"><i class="fa fa-tag fa-fw"></i></span>
                    <select class="form-control" name="unit_parent" id="unit_parent" style="font-family:'FontAwesome', Arial;">
                        ...
                        $db = new db();
                        $conn = $db -> connect();
                        $sql_unit = $conn->query("select * from unitkerja where SUBSTRING(kode,5,1)=0 order by jenis,kode asc");
                        while ($r = $sql_unit ->fetch_object()) {
                            if ($unit_parent==$r->kode) $pilih='selected="selected"';
                            else $pilih='';
                            echo '<option value="'.$r->kode.'" '.$pilih.'>['.$r->kode.'] '.$r->nama.'</option>'."\n";
