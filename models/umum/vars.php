...
$lvl_user=array(1=>"User",2=>"Admin",3=>"SuperAdmin");
$lvl_user_warna=array(1=>'<span class="label label-primary">User</span>',2=>'<span class="label label-warning">Admin</span>',3=>'<span class="label label-success">SuperAdmin</span>');
$status_umum=array(0=>'Tidak Aktif',1=>'Aktif');
$status_umum_warna=array(0=>'<span class="label label-danger">Tidak Aktif</span',1=>'<span class="label label-primary">Aktif</span>');
